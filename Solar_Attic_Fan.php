<!DOCTYPE html>
<!-- saved from url=(0043)https://koalainsulation.com/solar_attic_fan -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title> Solar Attic Fan </title>
         <link href="./Solar Attic Fan_files/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="./Solar Attic Fan_files/font-awesome.min.css">
    <link href="./Solar Attic Fan_files/slick.css" rel="stylesheet">
    <link href="./Solar Attic Fan_files/slick-theme.css" rel="stylesheet">
    <link href="./Solar Attic Fan_files/css2" rel="stylesheet">
    <link href="./Solar Attic Fan_files/css2(1)" rel="stylesheet">
    <link href="./Solar Attic Fan_files/aos.css" rel="stylesheet">
    <link href="./Solar Attic Fan_files/toastr.css" rel="stylesheet" type="text/css">
    <link href="./Solar Attic Fan_files/select2.min.css" rel="stylesheet">
    <link href="./Solar Attic Fan_files/style.css" rel="stylesheet">
    <link href="./Solar Attic Fan_files/custom.css" rel="stylesheet">
    <link href="./Solar Attic Fan_files/responsive.css" rel="stylesheet">

    <!-- Google tag (gtag.js) -->
    <script type="text/javascript" async="" src="./Solar Attic Fan_files/recaptcha__es.js.descarga" crossorigin="anonymous" integrity="sha384-kyoEFOB2fb2dMEbkOuXT0Jp8HpQJSBu/BYhjAwdaJkXOWdoaOU3/ko8yXbF1AhtG"></script><script async="" src="./Solar Attic Fan_files/js"></script>
...
<body class="solar_attic_fan  open_nav_overlay" data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    <!-- Start header -->
    <span role="button" class="acsb-sr-only acsb-skip-link" data-acsb="sr-trigger" data-acsb-sr-only="true" data-acsb-force-visible="true" aria-pressed="false"> Use Website In a Screen-Reader Mode </span><div class="acsb-skip-links acsb-force-visible acsb-ready" role="region" aria-label="Skip Links" data-acsb="skipLinks" style="display: none;"> <a href="https://koalainsulation.com/solar_attic_fan#acsbContent" data-acsb-skip-link="content" class="acsb-skip-link"> Skip to Content <div aria-hidden="true"><span class="acsb-symbol">↵</span>ENTER</div> </a> <a href="https://koalainsulation.com/solar_attic_fan#acsbMenu" data-acsb-skip-link="menu" class="acsb-skip-link"> Skip to Menu <div aria-hidden="true"><span class="acsb-symbol">↵</span>ENTER</div> </a> <a href="https://koalainsulation.com/solar_attic_fan#acsbFooter" data-acsb-skip-link="footer" class="acsb-skip-link"> Skip to Footer <div aria-hidden="true"><span class="acsb-symbol">↵</span>ENTER</div> </a>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-md navbar-dark">
                ...
                <a class="navbar-brand" href="https://koalainsulation.com/">
                    <img class="default_logo" src="./Solar Attic Fan_files/logo.svg" alt="logo">
                    <img class="sticky_logo" src="./Solar Attic Fan_files/koala-logo.png" alt="logo">
                </a>
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <div class="col-md-5">
                                            <div class="mega_menu_img">
                                                <img src="./Solar Attic Fan_files/dropdown-img.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="mobile-menu-section d-none">
                    <div class="mobile-menu">
                        <div class="menu-heading">Menu <a href="javascript:void(0)" class="close text-light" style="opacity: 1;"><img src="./Solar Attic Fan_files/close-icon.png"></a>
                        </div>
                        <ul class="menu-link">
...
<div class="main_wrap">
    <!-- Start hero Banner -->
        <section class="home_banner" style="background-image: url(&#39;https://koalainsulation.com/corp_images/attic-fans-banner.jpg&#39;);">
            <img class="d-none page_banner_mobile" src="./Solar Attic Fan_files/attic-fans-banner.jpg">
            <div class="container hero_caption">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="banner_caption_content ">
                            <h1>Solar Attic Fans</h1>
                            <p>Solar attic fans turn your attic into a livable space by pushing hot air out and pulling cool air in. Our fans use solar energy to keep your attic at a comfortable temperature year-round.</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section_header text-center mb-5">
                            <h2>Benefits Of Solar Attic Fans</h2>
                        </div>
                                    ...
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Solar Attic Fan_files/temperature_space_icon.png">
                                            </div>
                                            <h3>Makes Attics A Temperate Space</h3>
                                            <p>Regulates temperature inside attics making them more useable.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Solar Attic Fan_files/lower_bills_icon.png">
                                            </div>
                                            <h3>Can Decrease Energy Bills</h3>
                                            <p>Does not increase home energy use and can lower it during hot months.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Solar Attic Fan_files/eco_friendly_icon.png">
                                            </div>
                                            <h3>Eco-Friendly</h3>
                                            <p>Units are powered by renewable solar energy.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Solar Attic Fan_files/entire_home_icon.png">
                                            </div>
                                            <h3>Cools Entire Home</h3>
                                            <p>Keeps entire home at a more desirable temperature.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Solar Attic Fan_files/extend_life_icon.png">
                                            </div>
                                            <h3>Extends Life Of A/C Units</h3>
                                            <p>Helps carry the load of your home’s air conditioning.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Solar Attic Fan_files/prevent_mold_icon.png">
                                            </div>
                                            <h3>Prevents Mold &amp; Mildew</h3>
                                            <p>Ventilates attics to prevent the growth of mold.</p>
                                        </div>
                                    </li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2>Ready To Get Your Solar Attic Fan Installed?</h2>
                ...
                <div class="col-lg-5 col-md-4">
                    <div class="sub_footer_widget">
                        ...
                        <ul class="companies_logos">
                            ...
                            <li><a href="https://wallabywindows.com/" target="_blank"><img src="./Solar Attic Fan_files/wallaby-logo.png" alt=""></a></li>
                            <li><a href="https://koalaductcleaning.com/" target="_blank"><img src="./Solar Attic Fan_files/koala-duct-logo.png" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="footer_logo footer_widget">
                        <a href="https://koalainsulation.com/"><img src="./Solar Attic Fan_files/koala-logo.png"></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                    <div class="footer_address footer_widget">
                        ...
                        <ul class="footer-widget-address">
                            <li><img src="./Solar Attic Fan_files/address-icon.svg"> 445 West Drive <br>Melbourne, FL 32904</li>
                            <li><img src="./Solar Attic Fan_files/call-icon.svg"> <a href="tel:9543036361">(954) 303-6361</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="footer_socials footer_widget">
                        ...
                        <ul class="d-flex flex-wrap align-items-center">
                            <li><a href="https://www.facebook.com/KoalaInsulationHQ/" target="_blank"><img src="./Solar Attic Fan_files/fb-icon.png"></a></li>
                            <li><a href="https://www.instagram.com/koalainsulation/" target="_blank"><img src="./Solar Attic Fan_files/instagram-icon.png"></a></li>
                            <li><a href="https://www.youtube.com/channel/UCEYUbnu82sHwLIRzsY6qtPQ" target="_blank"><img src="./Solar Attic Fan_files/youtube-icon.png"></a></li>
                            <li><a href="https://www.linkedin.com/company/koalainsulation" target="_blank"><img src="./Solar Attic Fan_files/linkdein-icon.png"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="search_zip_code_modal">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <button type="button" class="close" data-dismiss="modal"><img src="./Solar Attic Fan_files/close-icon.png"></button>

                <!-- Modal body -->
                <div class="modal-body">
                    <div class="book_popup_model_content">
                        <div class="book_popup_model_img">
                            <img src="./Solar Attic Fan_files/Obie_Guide.png">
                        </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="zip_success_image_popup">
                    <img src="https://koalainsulation.com/solar_attic_fan">
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    ...
                    <div class="location_contact_method">
                        ...
                        <p class="calling_popup_ui"><a href="https://koalainsulation.com/solar_attic_fan#"><i class="fa fa-phone"></i> <span class="location_phone_number"></span></a></p>
                        <p class="calling_popup_ui"><a href="https://koalainsulation.com/solar_attic_fan#"><i class="fa fa-commenting"></i> <span class="location_phone_number"></span></a></p>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="https://koalainsulation.com/solar_attic_fan#" class="custom_btn ml-4 pulse-button"><i class="fa fa-phone"></i> <span class="location_phone_number"></span></a>
                    <button type="button" class="close" data-dismiss="modal"><img src="./Solar Attic Fan_files/close-icon.png"></button>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    <form class="estimate_form" id="estimate_form" action="https://koalainsulation.com/store_estimate" novalidate="novalidate">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="g-recaptcha" data-sitekey="6Lf4jcohAAAAAFPq6I_9sMzNrW3ogZx8tY26wDmC"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="./Solar Attic Fan_files/anchor.html" width="304" height="78" role="presentation" name="a-5rxahhwawgs8" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;" src="./Solar Attic Fan_files/saved_resource(1).html"></iframe></div>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<script>
    ...
    <script src="./Solar Attic Fan_files/jquery.min.js.descarga"></script>
    <script src="./Solar Attic Fan_files/bootstrap.min.js.descarga"></script>
    <script src="./Solar Attic Fan_files/jquery.validate.min.js.descarga"></script>
    <script src="./Solar Attic Fan_files/slick.js.descarga"></script>
    <script src="./Solar Attic Fan_files/aos.js.descarga"></script>
    <script src="./Solar Attic Fan_files/smk-accordion.js.descarga"></script>
    <script src="./Solar Attic Fan_files/toastr.min.js.descarga"></script>
    <script src="./Solar Attic Fan_files/select2.min.js.descarga"></script>
    <script src="./Solar Attic Fan_files/jquery.mask.js.descarga" integrity="sha256-yE5LLp5HSQ/z+hJeCqkz9hdjNkk1jaiGG0tDCraumnA=" crossorigin="anonymous"></script>
    <script src="./Solar Attic Fan_files/api.js.descarga" async="" defer=""></script>
    <script src="./Solar Attic Fan_files/custom.js.descarga"></script>
