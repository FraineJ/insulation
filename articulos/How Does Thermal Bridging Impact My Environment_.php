<!DOCTYPE html>
<!-- saved from url=(0060)https://koalainsulation.com/resource_detail/thermal-bridging -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5,user-scalable=0">
    <meta name="description" content="Thermal Bridging in your home may be more common than you realize! Uncovered wall studs, ceiling and floor joists, and improperly insulated structures are the perfect candidates to create a thermal bridging issue, click here to learn more!">
    <title> How Does Thermal Bridging Impact My Environment? </title>
         <link href="./How Does Thermal Bridging Impact My Environment__files/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="./How Does Thermal Bridging Impact My Environment__files/font-awesome.min.css">
    <link href="./How Does Thermal Bridging Impact My Environment__files/slick.css" rel="stylesheet">
    <link href="./How Does Thermal Bridging Impact My Environment__files/slick-theme.css" rel="stylesheet">
    <link href="./How Does Thermal Bridging Impact My Environment__files/css2" rel="stylesheet">
    <link href="./How Does Thermal Bridging Impact My Environment__files/css2(1)" rel="stylesheet">
    <link href="./How Does Thermal Bridging Impact My Environment__files/aos.css" rel="stylesheet">
    <link href="./How Does Thermal Bridging Impact My Environment__files/toastr.css" rel="stylesheet" type="text/css">
    <link href="./How Does Thermal Bridging Impact My Environment__files/select2.min.css" rel="stylesheet">
    <link href="./How Does Thermal Bridging Impact My Environment__files/style.css" rel="stylesheet">
    <link href="./How Does Thermal Bridging Impact My Environment__files/custom.css" rel="stylesheet">
    <link href="./How Does Thermal Bridging Impact My Environment__files/responsive.css" rel="stylesheet">

    <!-- Google tag (gtag.js) -->
    <script type="text/javascript" async="" src="./How Does Thermal Bridging Impact My Environment__files/recaptcha__es_419.js.descarga" crossorigin="anonymous" integrity="sha384-WM/sgzNtw4iH2/ZH/hoQ5dlGTd6FgIOjHg8JL8vB0GZLbOqblTl8k6SgUbldri8R"></script><script async="" src="./How Does Thermal Bridging Impact My Environment__files/js"></script>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-md navbar-dark">
                ...
                <a class="navbar-brand" href="https://koalainsulation.com/">
                    <img class="default_logo" src="./How Does Thermal Bridging Impact My Environment__files/logo.svg" alt="logo">
                    <img class="sticky_logo" src="./How Does Thermal Bridging Impact My Environment__files/koala-logo.png" alt="logo">
                </a>
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <div class="col-md-5">
                                            <div class="mega_menu_img">
                                                <img src="./How Does Thermal Bridging Impact My Environment__files/dropdown-img.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="mobile-menu-section d-none">
                    <div class="mobile-menu">
                        <div class="menu-heading">Menu <a href="javascript:void(0)" class="close text-light" style="opacity: 1;"><img src="./How Does Thermal Bridging Impact My Environment__files/close-icon.png"></a>
                        </div>
                        <ul class="menu-link">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="article_detail_img">
                            <img src="./How Does Thermal Bridging Impact My Environment__files/Koala-Insulation-thermal-bridging.jpg">
                        </div>
                    </div>
                    <div class="col-md-8">
                        <h2>How Does Thermal Bridging Impact My Environment?</h2>
                        <!-- wp:image {"id":4279,"sizeSlug":"large"} -->
<p><img alt="" src="./How Does Thermal Bridging Impact My Environment__files/Koala-Insulation-thermal-bridging-1024x576.jpg"></p>
<!-- /wp:image --><!-- wp:paragraph -->

<p>&nbsp;</p>
<!-- /wp:paragraph --><!-- wp:heading {"level":3} -->

<h3>What is Thermal Bridging?</h3>
<!-- /wp:heading --><!-- wp:paragraph -->

<p>According to the NCMA, <a href="https://ncma.org/resource/thermal-bridges-in-wall-construction/">thermal bridging</a> happens when “a relatively small area of a wall, floor or roof loses much more heat than the surrounding area.” A conductive material increases the rate of heat loss when there’s an imbalance of temperature between two areas, such as a heated home and the colder outside air. The most common example of a structure that allows thermal bridging would be your home’s wall studs. The conductive structures are the path of least resistance for heat, which creates a “bridge” for the energy to pass through. This can allow heat to escape from your home during the winter and enter the house during the summer.&nbsp;</p>
<!-- /wp:paragraph --><!-- wp:paragraph -->

<p>Uncovered wall studs, ceiling and floor joists, and improperly insulated structures are the perfect candidates to create a thermal bridging issue. These materials are a significant contribution to heat loss, irregular temperatures, and the increased risk of other climate control issues such as <a href="https://koalainsulation.com/resource_detail/what-is-the-stack-effect-how-to-reduce-heat-loss-what-is-the-stack-effect-how-to-reduce-heat-loss">the stack effect</a>. When your home isn’t prepared to reduce heat transfer - the rate at which heat can enter and exit a building - you may notice an increase in discomfort, health concerns, and monthly spending.&nbsp;</p>
<!-- /wp:paragraph --><!-- wp:heading {"level":3} -->

<h3>The Bigger Problem</h3>
<!-- /wp:heading --><!-- wp:paragraph -->

<p>Insulation is installed throughout your home to help reduce heat transfer and regulate the temperature throughout the house. However, even if you have the right material installed between joists and floorboards, uncovered structures can still act as a gateway for the heat to easily pass through. Gaps in between insulation can lead to thermal bridging, air leaks, and other issues that impact the comfort of your environment. Unregulated heat transfer can also result in higher utility bills; your HVAC system has to put in extra work in order to replace the air that’s being lost through heat transfer.&nbsp;</p>
<!-- /wp:paragraph --><!-- wp:paragraph -->

<p>Another significant issue thermal bridging brings to your home is the threat of condensation and moisture damage. As warm air interacts with cooler surfaces and condenses, the resulting water droplets can lead to rot, mold, and damaged insulation. Mold growth and bacteria can increase the risk of health hazards and reduce indoor air quality. Moist wood also attracts pests like dust mites, termites, and carpenter ants. With the additional threat of rot, the structural integrity of your home could be put in serious jeopardy.&nbsp;</p>
<!-- /wp:paragraph --><!-- wp:heading {"level":3} -->

<h3>How Can Insulation Reduce Thermal Bridging?</h3>
<!-- /wp:heading --><!-- wp:paragraph -->

<p>The insulation throughout your home helps to create a <em>thermal break</em>, which provides a barrier between a structure and heat. In most existing buildings, homeowners can simply work with an insulation team to find the right material to cover these joists and studs to help reduce thermal bridging and heat transfer. However, in some older homes, there may be many areas that can lead to thermal bridging; this is because thermal bridging wasn’t considered a major concern in <a href="https://www.buildwithrise.com/stories/thermal-bridging">construction development until recent advancements and research in the industry</a>. One of the most effective solutions experts have been recommending is to add a continuous layer of insulation throughout a structure. With regular inspection and maintenance, homeowners can reduce the threat posed by deteriorated or damaged material.&nbsp;</p>
<!-- /wp:paragraph --><!-- wp:paragraph -->

<p>For new construction projects, contractors also have the option of building with SIPs (structural insulated panels) or framing with advanced techniques that reduce the use of wall studs without harming the structural integrity of your building. When working on the development of your new home or business building, it's crucial to consult industry experts that not only have experience in energy-efficient practices but can also provide advice on reducing energy usage through preventative measures. One of the best ways you can get ahead of additional costs is by staying involved in the early processes, implementing practices and methods that will support your building envelope for years.&nbsp;</p>
<!-- /wp:paragraph --><!-- wp:heading {"level":3} -->

<h3>Find More Answers to Insulation FAQs</h3>
<!-- /wp:heading --><!-- wp:paragraph -->

<p>Having a better understanding of your home’s insulation can help you make informed decisions on your next home improvement project. Thermal bridging may seem like a technical problem for construction professionals and other industry experts to be concerned with, but homeowners should also take an interest in these phenomena. Doing so could reduce costly mistakes and energy waste! When looking to make cost-effective and energy-efficient renovations, your comfort and safety shouldn’t be an afterthought.&nbsp;</p>
<!-- /wp:paragraph --><!-- wp:paragraph -->

<p>At Koala Insulation, our insulation professionals are not only trained and experienced to improve our communities but also answer commonly asked questions about insulation and air sealing. Your local team can help you and your household understand the needs of your home so you can make decisions that take into account your schedule and budget. By conducting free evaluations, Koala Insulation can provide a detailed breakdown of your home’s insulation and air sealing condition in order to provide the best options that cover comfort, safety, and savings. <a href="https://koalainsulation.com/locations/">Contact your local Koala Insulation crew today</a> to schedule your free evaluations and learn more about the impact of insulation on your environment.&nbsp;</p>
<!-- /wp:paragraph -->

                        <div class="d-flex flex-wrap">
                            <div class="ss" style="border:1px solid;padding: 5px 8px;">
                                <a class="fbk" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https://koalainsulation.com/resource_detail/thermal-bridging">
                                    <i class="fa fa-facebook"></i> <span></span>
                                </a>
                            </div>
                            <div class="ss ml-2" style="border:1px solid;padding: 5px 8px;">
                                <a class="lk" target="_blank" href="https://www.linkedin.com/cws/share?url=https://koalainsulation.com/resource_detail/thermal-bridging">
                ...
                <div class="col-lg-5 col-md-4">
                    <div class="sub_footer_widget">
                        ...
                        <ul class="companies_logos">
                            ...
                            <li><a href="https://wallabywindows.com/" target="_blank"><img src="./How Does Thermal Bridging Impact My Environment__files/wallaby-logo.png" alt=""></a></li>
                            <li><a href="https://koalaductcleaning.com/" target="_blank"><img src="./How Does Thermal Bridging Impact My Environment__files/koala-duct-logo.png" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="footer_logo footer_widget">
                        <a href="https://koalainsulation.com/"><img src="./How Does Thermal Bridging Impact My Environment__files/koala-logo.png"></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                    <div class="footer_address footer_widget">
                        ...
                        <ul class="footer-widget-address">
                            <li><img src="./How Does Thermal Bridging Impact My Environment__files/address-icon.svg"> 445 West Drive <br>Melbourne, FL 32904</li>
                            <li><img src="./How Does Thermal Bridging Impact My Environment__files/call-icon.svg"> <a href="tel:8005204952">(877) 87 KOALA</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="footer_socials footer_widget">
                        ...
                        <ul class="d-flex flex-wrap align-items-center">
                            <li><a href="https://www.facebook.com/KoalaInsulationHQ/" target="_blank"><img src="./How Does Thermal Bridging Impact My Environment__files/fb-icon.png"></a></li>
                            <li><a href="https://www.instagram.com/koalainsulation/" target="_blank"><img src="./How Does Thermal Bridging Impact My Environment__files/instagram-icon.png"></a></li>
                            <li><a href="https://www.youtube.com/channel/UCEYUbnu82sHwLIRzsY6qtPQ" target="_blank"><img src="./How Does Thermal Bridging Impact My Environment__files/youtube-icon.png"></a></li>
                            <li><a href="https://www.linkedin.com/company/koalainsulation" target="_blank"><img src="./How Does Thermal Bridging Impact My Environment__files/linkdein-icon.png"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="search_zip_code_modal">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <button type="button" class="close" data-dismiss="modal"><img src="./How Does Thermal Bridging Impact My Environment__files/close-icon.png"></button>

                <!-- Modal body -->
                <div class="modal-body">
                    <div class="book_popup_model_content">
                        <div class="book_popup_model_img">
                            <img src="./How Does Thermal Bridging Impact My Environment__files/Obie_Guide.png">
                        </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="zip_success_image_popup">
                    <img src="https://koalainsulation.com/resource_detail/thermal-bridging">
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    ...
                    <div class="location_contact_method">
                        ...
                        <p class="calling_popup_ui"><a href="https://koalainsulation.com/resource_detail/thermal-bridging#"><i class="fa fa-phone"></i> <span class="location_phone_number"></span></a></p>
                        <p class="calling_popup_ui"><a href="https://koalainsulation.com/resource_detail/thermal-bridging#"><i class="fa fa-commenting"></i> <span class="location_phone_number"></span></a></p>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="https://koalainsulation.com/resource_detail/thermal-bridging#" class="custom_btn ml-4 pulse-button"><i class="fa fa-phone"></i> <span class="location_phone_number"></span></a>
                    <button type="button" class="close" data-dismiss="modal"><img src="./How Does Thermal Bridging Impact My Environment__files/close-icon.png"></button>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    <form class="estimate_form" id="estimate_form" action="https://koalainsulation.com/store_estimate" novalidate="novalidate">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="g-recaptcha" data-sitekey="6Lf4jcohAAAAAFPq6I_9sMzNrW3ogZx8tY26wDmC"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="./How Does Thermal Bridging Impact My Environment__files/anchor.html" width="304" height="78" role="presentation" name="a-ndmow6017g2" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;" src="./How Does Thermal Bridging Impact My Environment__files/saved_resource.html"></iframe></div>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<script>
    ...
    <script src="./How Does Thermal Bridging Impact My Environment__files/jquery.min.js.descarga"></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/bootstrap.min.js.descarga"></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/jquery.validate.min.js.descarga"></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/slick.js.descarga"></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/aos.js.descarga"></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/smk-accordion.js.descarga"></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/toastr.min.js.descarga"></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/select2.min.js.descarga"></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/jquery.mask.js.descarga" integrity="sha256-yE5LLp5HSQ/z+hJeCqkz9hdjNkk1jaiGG0tDCraumnA=" crossorigin="anonymous"></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/api.js.descarga" async="" defer=""></script>
    <script src="./How Does Thermal Bridging Impact My Environment__files/custom.js.descarga"></script>
