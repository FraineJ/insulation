...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="./insulation_files/css">
    <link type="text/css" rel="stylesheet" href="./insulation_files/css(1)">
    <style>
        .gm-ui-hover-effect {
            opacity: .6
        }
    ...
    <title> Home </title>
    <link href="./insulation_files/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="./insulation_files/font-awesome.min.css">
    <link href="./insulation_files/slick.css" rel="stylesheet">
    <link href="./insulation_files/slick-theme.css" rel="stylesheet">
    <link href="./insulation_files/css2" rel="stylesheet">
    <link href="./insulation_files/css2(1)" rel="stylesheet">
    <link href="./insulation_files/aos.css" rel="stylesheet">
    <link href="./insulation_files/toastr.css" rel="stylesheet" type="text/css">
    <link href="./insulation_files/select2.min.css" rel="stylesheet">
    <link href="./insulation_files/style.css" rel="stylesheet">
    <link href="./insulation_files/custom.css" rel="stylesheet">
    <link href="./insulation_files/responsive.css" rel="stylesheet">

    <!-- Google tag (gtag.js) -->
    <script type="text/javascript" async="" src="./insulation_files/recaptcha__es.js.descarga" crossorigin="anonymous"
        integrity="sha384-76K8XpftVy4UC3GsI2HkNSc4cWfRT0D4voltT5mGRkGP33WHbKB/prQgM91KI2up"></script>
    <script async="" src="./insulation_files/js"></script>
    ...
    <script type="text/javascript" charset="UTF-8" src="./insulation_files/common.js.descarga"></script>
    <script type="text/javascript" charset="UTF-8" src="./insulation_files/util.js.descarga"></script>
    <script type="text/javascript" charset="UTF-8" src="./insulation_files/map.js.descarga"></script>
    <script type="text/javascript" charset="UTF-8" src="./insulation_files/marker.js.descarga"></script>
...
<body class=" home " data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    <!-- Start header -->
    <span role="button" class="acsb-sr-only acsb-skip-link" data-acsb="sr-trigger" data-acsb-sr-only="true"
        data-acsb-force-visible="true" aria-pressed="false"> Use Website In a Screen-Reader Mode </span>
    <div class="acsb-skip-links acsb-force-visible acsb-ready" role="region" aria-label="Skip Links"
        data-acsb="skipLinks" style="display: none;"> <a href="https://koalainsulation.com/#acsbContent"
            data-acsb-skip-link="content" class="acsb-skip-link"> Skip to Content <div aria-hidden="true"><span
                    class="acsb-symbol">↵</span>ENTER</div> </a> <a href="https://koalainsulation.com/#acsbMenu"
            data-acsb-skip-link="menu" class="acsb-skip-link"> Skip to Menu <div aria-hidden="true"><span
                    class="acsb-symbol">↵</span>ENTER</div> </a> <a href="https://koalainsulation.com/#acsbFooter"
            data-acsb-skip-link="footer" class="acsb-skip-link"> Skip to Footer <div aria-hidden="true"><span
                    class="acsb-symbol">↵</span>ENTER</div> </a>
    </div>
    <div class="acsb-trigger acsb-bg-lead acsb-trigger-size-medium acsb-trigger-position-x-right acsb-trigger-position-y-bottom acsb-ready"
        ...
        aria-label="Open accessiBe: accessibility options, statement and help" data-acsb="trigger"> <span
            class="acsb-trigger-icon"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 100 131.3"
            ...
            </svg></span><span class="acsb-actions-active-icon"> <svg width="21" height="21" viewBox="0 0 21 21"
            ...
            <nav class="navbar navbar-expand-md navbar-dark">
                ...
                <button class="toggle_button d-none" type="button">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="42" height="26" viewBox="0 0 42 26">
                        <g id="Group_637" data-name="Group 637" transform="translate(-534.5 -68.5)">
                            <line id="Line_113" data-name="Line 113" x2="38" transform="translate(536.5 70.5)"
                                fill="none" stroke="#fff" stroke-linecap="round" stroke-width="4"></line>
                            <line id="Line_114" data-name="Line 114" x2="38" transform="translate(536.5 81.5)"
                                fill="none" stroke="#fff" stroke-linecap="round" stroke-width="4"></line>
                            <line id="Line_115" data-name="Line 115" x2="38" transform="translate(536.5 92.5)"
                                fill="none" stroke="#fff" stroke-linecap="round" stroke-width="4"></line>
                        </g>
                    </svg>
                </button>
                ...
                <div class="navbar-collapse justify-content-end desktop_navbar" id="collapsibleNavbar">
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item">
                            <a class="nav-link" href="index.php">Start Here</a>
                        </li>
                        <li class="nav-item dropdown mega-dropdown custom_dropdown">
                            <a class="nav-link" href="https://koalainsulation.com/our_services"
                                    ...
                                    <div class="row m-0">
                                                    ...
                                                    <div class="col-md-6">
                                                        <ul class="submenu_ul">
                                                            ...
                                                            <li><a
                                                                    ...
                                                                    Insulation</a></li>
                                                            <li><a
                                                                    href="Spray_Foam_Insulation.php">Spray
                                                                    Foam Insulation</a></li>
                                                            <li><a href="Air_Sealing.php">Air
                                                                    Sealing</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-5">
                                            <div class="mega_menu_img">
                                                <img src="./insulation_files/dropdown-img.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Why_insulation.php">Why Insulationusa?</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="Resource.php">Free Resources</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="mobile-menu-section d-none">
                    <div class="mobile-menu">
                        <div class="menu-heading">Menu <a href="javascript:void(0)" class="close text-light"
                                style="opacity: 1;"><img src="./insulation_files/close-icon.png"></a>
                        </div>
                        <ul class="menu-link">
