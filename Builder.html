<!DOCTYPE html>
<!-- saved from url=(0035)https://koalainsulation.com/builder -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <title> Builder </title>
         <link href="./Builder_files/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="./Builder_files/font-awesome.min.css">
    <link href="./Builder_files/slick.css" rel="stylesheet">
    <link href="./Builder_files/slick-theme.css" rel="stylesheet">
    <link href="./Builder_files/css2" rel="stylesheet">
    <link href="./Builder_files/css2(1)" rel="stylesheet">
    <link href="./Builder_files/aos.css" rel="stylesheet">
    <link href="./Builder_files/toastr.css" rel="stylesheet" type="text/css">
    <link href="./Builder_files/select2.min.css" rel="stylesheet">
    <link href="./Builder_files/style.css" rel="stylesheet">
    <link href="./Builder_files/custom.css" rel="stylesheet">
    <link href="./Builder_files/responsive.css" rel="stylesheet">

    <!-- Google tag (gtag.js) -->
    <script type="text/javascript" async="" src="./Builder_files/recaptcha__es.js.descarga" crossorigin="anonymous" integrity="sha384-kyoEFOB2fb2dMEbkOuXT0Jp8HpQJSBu/BYhjAwdaJkXOWdoaOU3/ko8yXbF1AhtG"></script><script async="" src="./Builder_files/js"></script>
...
<body class="builder   open_nav_overlay" data-aos-easing="ease" data-aos-duration="400" data-aos-delay="0">
    <!-- Start header -->
    <span role="button" class="acsb-sr-only acsb-skip-link" data-acsb="sr-trigger" data-acsb-sr-only="true" data-acsb-force-visible="true" aria-pressed="false"> Use Website In a Screen-Reader Mode </span><div class="acsb-skip-links acsb-force-visible acsb-ready" role="region" aria-label="Skip Links" data-acsb="skipLinks" style="display: none;"> <a href="https://koalainsulation.com/builder#acsbContent" data-acsb-skip-link="content" class="acsb-skip-link"> Skip to Content <div aria-hidden="true"><span class="acsb-symbol">↵</span>ENTER</div> </a> <a href="https://koalainsulation.com/builder#acsbMenu" data-acsb-skip-link="menu" class="acsb-skip-link"> Skip to Menu <div aria-hidden="true"><span class="acsb-symbol">↵</span>ENTER</div> </a> <a href="https://koalainsulation.com/builder#acsbFooter" data-acsb-skip-link="footer" class="acsb-skip-link"> Skip to Footer <div aria-hidden="true"><span class="acsb-symbol">↵</span>ENTER</div> </a>
        ...
        <div class="container">
            <nav class="navbar navbar-expand-md navbar-dark">
                ...
                <a class="navbar-brand" href="https://koalainsulation.com/">
                    <img class="default_logo" src="./Builder_files/logo.svg" alt="logo">
                    <img class="sticky_logo" src="./Builder_files/koala-logo.png" alt="logo">
                </a>
                ...
                <div class="navbar-collapse justify-content-end desktop_navbar" id="collapsibleNavbar">
                    <ul class="navbar-nav align-items-center">
                        ...
                        <li class="nav-item dropdown mega-dropdown custom_dropdown show">
                            <a class="nav-link" href="https://koalainsulation.com/our_services" data-toggle="dropdown" aria-expanded="true">Services <i class="fa fa-angle-down"></i></a>
                                    ...
                                    <div class="row m-0">
                                        ...
                                        <div class="col-md-5">
                                            <div class="mega_menu_img">
                                                <img src="./Builder_files/dropdown-img.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="mobile-menu-section d-none">
                    <div class="mobile-menu">
                        <div class="menu-heading">Menu <a href="javascript:void(0)" class="close text-light" style="opacity: 1;"><img src="./Builder_files/close-icon.png"></a>
                        </div>
                        <ul class="menu-link">
...
<div class="main_wrap">
    <!-- Start hero Banner -->
        <section class="home_banner" style="background-image: url(&#39;https://koalainsulation.com/corp_images/builder-banner.jpg&#39;);">
            <img class="d-none page_banner_mobile" src="./Builder_files/builder-banner.jpg">
            <div class="container hero_caption">
                <div class="row">
                    <div class="col-lg-7">
                        <div class="banner_caption_content ">
                            <h1>Builder Services</h1>
                            <p>Residential, commercial, and industrial builders benefit from the highest quality installations. Our vast experience working with builders and renovators helps you complete projects on-time, as scheduled.</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="section_header text-center mb-5">
                            <h2>Why Koala Is The Top Choice For Commercial</h2>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <ul class="d-flex flex-wrap justify-content-center service_benefits_uline atticfans_benefits_uline">
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Builder_files/quality_installation_icon.png">
                                            </div>
                                            <h3>High-Quality Installation</h3>
                                            <p>Our experience and precision mean each project is done on-time, and with unmatched workmanship.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Builder_files/always_know_icon.png">
                                            </div>
                                            <h3>Always Be In-The-Know</h3>
                                            <p>Get real-time arrival, departure, and completion alerts.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Builder_files/large_project_icon.png">
                                            </div>
                                            <h3>Experience With Large Projects</h3>
                                            <p>Work alongside a team with vast experience helping complete commercial builds.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Builder_files/avoid_mistake_icon.png">
                                            </div>
                                            <h3>Avoid Costly Mistakes</h3>
                                            <p>Our attention to detail and care means you avoid paying for costly mistakes.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Builder_files/trustworthy_icon.png">
                                            </div>
                                            <h3>Flexible. Reliable. Trustworthy.</h3>
                                            <p>Call whenever you need us for a quick job or last-minute fill-in.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Builder_files/code_compliance_icon.png">
                                            </div>
                                            <h3>Inspection &amp; Code Compliance</h3>
                                            <p>New insulation will increase your home's resale value.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Builder_files/brand_product_icon.png">
                                            </div>
                                            <h3>Brand Name Products</h3>
                                            <p>We use only the best quality name brand products you know and trust.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Builder_files/licensed_insured_icon.png">
                                            </div>
                                            <h3>Licensed &amp; Insured</h3>
                                            <p>We are fully insured so you can stay protected from the unexpected.</p>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="f_grid_vs text-center">
                                            <div class="f_grid_icon">
                                                <img src="./Builder_files/flexible_payment_icon.png">
                                            </div>
                                            <h3>Flexible Payment Terms</h3>
                                            <p>Enjoy flexible payment terms. We accept credit cards, ACH, and checks.</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="mt-4">
                            <p class="text-center lead_txt" style="color: #043868; font-weight: 500;">Find your nearest Koala location to learn more about our builder services.</p>
                            <form action="https://koalainsulation.com/find_zip_code" class="find_nearest_form mt-4">
                                <input type="hidden" name="_token" value="y9IhyvSlBIQvMY2spG6BKiqzTAfoOrz3FRoQaku4">                                <input type="text" name="zip_code" maxlength="6" class="form-control" placeholder="Your ZIP Code">
                                <button type="button" class="custom_btn_orange fynl_btn">FIND YOUR NEAREST LOCATION</button>
                            </form>
        ...
        <section class="satisfy_customer pt-5" style="background-image: url(&#39;https://koalainsulation.com/corp_images/donnie_customer_bg.jpg&#39;);">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="satisfy_customer_content green_dark_shade_bg aos-init" data-aos="fade-up" data-aos-duration="1200">
                            <p>“I have worked with many subcontractors in my home building career, and the crews at Koala are some of the best people I’ve worked with. They are a pleasure to do business with and I’d recommend them to anyone looking for a high-quality insulation subcontractor.”  </p>
                            <div class="customer_detail">
                                <h4><strong>- Donnie J.</strong></h4>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="service_made_from blue_dark_bg pt-80 pb-80">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="section_header text-center mb-5">
                            <h2 class="text-white">Expert Installation For Any Building</h2>
                        </div>
                        <ul class="service_made_from_uline builder_service_expert_uline">
                            <li>
                                <div class="service_made_from_grid">
                                    <img src="./Builder_files/office_building_img.png">
                                    <p>Office Buildings</p>
                                </div>
                            </li>
                            <li>
                                <div class="service_made_from_grid">
                                    <img src="./Builder_files/retail_price_img.png">
                                    <p>Retail Space</p>
                                </div>
                            </li>
                            <li>
                                <div class="service_made_from_grid">
                                    <img src="./Builder_files/industrial_warehouse_img.png">
                                    <p>Industrial &amp; Warehouse</p>
                                </div>
                            </li>
                            <li>
                                <div class="service_made_from_grid">
                                    <img src="./Builder_files/restaurants_img.png">
                                    <p>Restaurants</p>
                                </div>
                            </li>
                            <li>
                                <div class="service_made_from_grid">
                                    <img src="./Builder_files/healthcare_img.png">
                                    <p>Healthcare &amp; More</p>
                                </div>
                            </li>
                        </ul>
        ...
        <section class="service_common_area builder_service_commercial_area pt-80 pb-80">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="d-flex flex-wrap justify-content-center">
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/spray-foam-icon.svg">
                                    </div>
                                    <h3>Spray Foam<br> Insulation</h3>
                                </div>
                            </li>
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/blown-in-icon.svg">
                                    </div>
                                    <h3>Blown-In <br>Insulation</h3>
                                </div>
                            </li>
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/batt-insulation-icon.svg">
                                    </div>
                            ...
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/insulation-removal-icon.svg">
                                    </div>
                                    <h3>Insulation Removal <br>&amp; Haul Off</h3>
                                </div>
                            </li>
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/intumescent-coatings-icon.svg">
                                    </div>
                                    <h3>Intumescent Coatings (Ignition &amp; Thermal Barriers)</h3>
                                </div>
                            </li> 
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/air-sealing-icon.svg">
                                    </div>
                                    <h3>Air Sealing &amp; Fire Caulking</h3>
                                </div>
                            </li>
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/baffle-installation-icon.svg">
                                    </div>
                                    <h3>Baffle Installation</h3>
                                </div>
                            </li>
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/recessed-lights-icon.svg">
                                    </div>
                                    <h3>Attic Hatch &amp; <br>Can-Light Covers</h3>
                                </div>
                            </li>
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/crawl-services-icon.svg">
                                    </div>
                                    <h3>Crawl Space <br>Services</h3>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="f_grid_vs text-center">
                                    <div class="f_grid_icon">
                                        <img src="./Builder_files/complimentary-icon.svg">
                                    </div>
                                    <h3>Complimentary <br>Services</h3>
                                </div>
                            </li>
                        </ul>
                    </div>
        ...
        <section class="satisfy_customer pt-5" style="background-image: url(&#39;https://koalainsulation.com/corp_images/tyler_customer_bg.jpg&#39;);">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="satisfy_customer_content green_dark_shade_bg aos-init" data-aos="fade-up" data-aos-duration="1200">
                            <p>“Wow! If all of our subcontractors were as organized, punctual, and put together as Koala, I could easily take on more projects.” </p>
                            <div class="customer_detail">
                                <h4><strong>- Tyler</strong></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <h2>Ready To Make Koala Your Go-To Subcontractor?</h2>
                        <p class="lead_txt">Find your nearest Koala location to speak with a representative.</p>
                        <form action="https://koalainsulation.com/find_zip_code" class="find_nearest_form mt-4">
                            <input type="hidden" name="_token" value="y9IhyvSlBIQvMY2spG6BKiqzTAfoOrz3FRoQaku4">                            <input type="text" name="zip_code" maxlength="6" class="form-control" placeholder="Your ZIP Code">
                            <button type="button" class="custom_btn_orange fynl_btn">FIND YOUR NEAREST LOCATION</button>
                        </form>
                ...
                <div class="col-lg-5 col-md-4">
                    <div class="sub_footer_widget">
                        ...
                        <ul class="companies_logos">
                            ...
                            <li><a href="https://wallabywindows.com/" target="_blank"><img src="./Builder_files/wallaby-logo.png" alt=""></a></li>
                            <li><a href="https://koalaductcleaning.com/" target="_blank"><img src="./Builder_files/koala-duct-logo.png" alt=""></a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="footer_logo footer_widget">
                        <a href="https://koalainsulation.com/"><img src="./Builder_files/koala-logo.png"></a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                    <div class="footer_address footer_widget">
                        ...
                        <ul class="footer-widget-address">
                            <li><img src="./Builder_files/address-icon.svg"> 445 West Drive <br>Melbourne, FL 32904</li>
                            <li><img src="./Builder_files/call-icon.svg"> <a href="tel:9543036361">(954) 303-6361</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3">
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="footer_socials footer_widget">
                        ...
                        <ul class="d-flex flex-wrap align-items-center">
                            <li><a href="https://www.facebook.com/KoalaInsulationHQ/" target="_blank"><img src="./Builder_files/fb-icon.png"></a></li>
                            <li><a href="https://www.instagram.com/koalainsulation/" target="_blank"><img src="./Builder_files/instagram-icon.png"></a></li>
                            <li><a href="https://www.youtube.com/channel/UCEYUbnu82sHwLIRzsY6qtPQ" target="_blank"><img src="./Builder_files/youtube-icon.png"></a></li>
                            <li><a href="https://www.linkedin.com/company/koalainsulation" target="_blank"><img src="./Builder_files/linkdein-icon.png"></a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="search_zip_code_modal">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <button type="button" class="close" data-dismiss="modal"><img src="./Builder_files/close-icon.png"></button>

                <!-- Modal body -->
                <div class="modal-body">
                    <div class="book_popup_model_content">
                        <div class="book_popup_model_img">
                            <img src="./Builder_files/Obie_Guide.png">
                        </div>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="zip_success_image_popup">
                    <img src="https://koalainsulation.com/builder">
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    ...
                    <div class="location_contact_method">
                        ...
                        <p class="calling_popup_ui"><a href="https://koalainsulation.com/builder#"><i class="fa fa-phone"></i> <span class="location_phone_number"></span></a></p>
                        <p class="calling_popup_ui"><a href="https://koalainsulation.com/builder#"><i class="fa fa-commenting"></i> <span class="location_phone_number"></span></a></p>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="https://koalainsulation.com/builder#" class="custom_btn ml-4 pulse-button"><i class="fa fa-phone"></i> <span class="location_phone_number"></span></a>
                    <button type="button" class="close" data-dismiss="modal"><img src="./Builder_files/close-icon.png"></button>
                </div>
                <!-- Modal body -->
                <div class="modal-body">
                    <form class="estimate_form" id="estimate_form" action="https://koalainsulation.com/store_estimate" novalidate="novalidate">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <div class="g-recaptcha" data-sitekey="6Lf4jcohAAAAAFPq6I_9sMzNrW3ogZx8tY26wDmC"><div style="width: 304px; height: 78px;"><div><iframe title="reCAPTCHA" src="./Builder_files/anchor.html" width="304" height="78" role="presentation" name="a-cjga7ywgcuec" frameborder="0" scrolling="no" sandbox="allow-forms allow-popups allow-same-origin allow-scripts allow-top-navigation allow-modals allow-popups-to-escape-sandbox"></iframe></div><textarea id="g-recaptcha-response" name="g-recaptcha-response" class="g-recaptcha-response" style="width: 250px; height: 40px; border: 1px solid rgb(193, 193, 193); margin: 10px 25px; padding: 0px; resize: none; display: none;"></textarea></div><iframe style="display: none;" src="./Builder_files/saved_resource.html"></iframe></div>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<script>
    ...
    <script src="./Builder_files/jquery.min.js.descarga"></script>
    <script src="./Builder_files/bootstrap.min.js.descarga"></script>
    <script src="./Builder_files/jquery.validate.min.js.descarga"></script>
    <script src="./Builder_files/slick.js.descarga"></script>
    <script src="./Builder_files/aos.js.descarga"></script>
    <script src="./Builder_files/smk-accordion.js.descarga"></script>
    <script src="./Builder_files/toastr.min.js.descarga"></script>
    <script src="./Builder_files/select2.min.js.descarga"></script>
    <script src="./Builder_files/jquery.mask.js.descarga" integrity="sha256-yE5LLp5HSQ/z+hJeCqkz9hdjNkk1jaiGG0tDCraumnA=" crossorigin="anonymous"></script>
    <script src="./Builder_files/api.js.descarga" async="" defer=""></script>
    <script src="./Builder_files/custom.js.descarga"></script>
